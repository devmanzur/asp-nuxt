...
{
    public partial class InitialModelsCreatedForCart : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthenticationProvider = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address_Title = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
